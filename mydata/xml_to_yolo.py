...
def convert_annotation(image_id):
    in_file = open('G:/yolov5-master/mydata/Annotations/%s.xml' % (image_id), encoding='UTF-8')
    out_file = open('G:/yolov5-master/mydata/labels/%s.txt' % (image_id), 'w')
...
for image_set in sets:
    ...
    image_ids = open('G:/yolov5-master/mydata/ImageSets/Main/%s.txt' % (image_set)).read().strip().split()
